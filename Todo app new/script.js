...
addBtn.addEventListener('click',(event)=>{
    ...
    ul.innerHTML +=`<li id="${list.length-1}" class="list">
          <input type="checkbox" id="todo-1" >
                    <label for="${list.length}" class="custom-checkbox"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="transparent"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg></label>
                    <label for="${list.length}" class="todo-text">${addTask.value}</label>
